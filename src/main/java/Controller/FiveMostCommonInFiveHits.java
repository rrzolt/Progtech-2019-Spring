...
public class FiveMostCommonInFiveHits implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        setTexts(Statistics.numbersInFiveHits().get(0),number1,numberOfTimesPicked1,lastTimePicked1,numberOfBeingInFiveHits1,numberPercentage1);
        setTexts(Statistics.numbersInFiveHits().get(1),number2,numberOfTimesPicked2,lastTimePicked2,numberOfBeingInFiveHits2,numberPercentage2);
        setTexts(Statistics.numbersInFiveHits().get(2),number3,numberOfTimesPicked3,lastTimePicked3,numberOfBeingInFiveHits3,numberPercentage3);
        setTexts(Statistics.numbersInFiveHits().get(3),number4,numberOfTimesPicked4,lastTimePicked4,numberOfBeingInFiveHits4,numberPercentage4);
        setTexts(Statistics.numbersInFiveHits().get(4),number5,numberOfTimesPicked5,lastTimePicked5,numberOfBeingInFiveHits5,numberPercentage5);
    }
